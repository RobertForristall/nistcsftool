      ...
      <div class="main-container">
        ...
        <form @submit.prevent="submit">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nameOfNewApp" aria-describedby="nameHelp" v-model="name">
                <div id="nameHelp" class="form-text">Name of the application who's compliance will be tracked</div>
            </div>
            <div class="mb-3">
                <label for="typeOfNewApp" class="form-label">Type of New App</label>
                <input type="text" class="form-control" id="typeOfNewApp" v-model="type">
            </div>
        ...
        <div>
          <button 
            ...
            @click="store.pageFlag = 0">Back</button>
        </div>
      </div>
    </div>
  </template>
